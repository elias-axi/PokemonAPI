...
namespace PokemonAPI.Controllers
{
    ...
    public class PokemonController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="request">Objeto que contiene el nombre del Pokémon a buscar</param>
        ...
        [HttpPost("GetPokemonByName")]
        [ProducesResponseType(typeof(PokemonResponseDto), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> GetPokemonByName([FromBody] PokemonRequest request)
        {
            try
            {
                ...
                if (pokemon == null)
                {
                    return NotFound(new { message = $"Pokémon '{request.Name}' no encontrado" });
                }
            ...
            {
                _logger.LogError(ex, "Error al buscar el Pokémon {Name}", request.Name);
